...
author: "David Yen-Chieh Liao (Ph.D in Politics, Essex)"
...
p_load(
  ...
  ggplot2, ggthemes, ggeffects, ggridges, 
  igraph, network, ggpubr,
  ggformula, gridExtra, RColorBrewer, # Visualization
...
# pagedown::chrome_print("file:///Users/yenchiehliao/Library/CloudStorage/Dropbox/erdp-new-2023/erfp-ecpr-parliarment/erfp-ecpr-parliarment.html#1", verbose = FALSE)
...
- .grey[OLS Regression Predicting the Impact of Electoral Reform] .grey[([Table 1](#table-1) | [Table 2](#table-2))] <br> 

- .grey[Robustness Estimation Using Separate Samples] .grey[([Table F.5](#seperate-inter) | [Table F.6](#seperate-intra))] <br> 

- .grey[Evaluating the Heterogeneity in Voting Records]  .grey[([Table G.7](#table-g.7) | [Table G.8](##table-g.8))] <br> 

- .grey[Robustness Assessment of the Effect of a Reform using Panel Data: Evidence from the 6th to 7th Term Observations] .grey[([Table H.9](#table-h.9) ] <br> 

- .grey[Robustness Assessment of the Reform's Effect at the Session Level using GMM] .grey[([Table I.10](#table-i.10))] <br> 
